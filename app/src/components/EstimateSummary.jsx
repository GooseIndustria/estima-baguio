...
export function EstimateSummary() {
    ...
    const handleExportPDF = useCallback(() => {
        ...
        doc.setFontSize(12);
        doc.setTextColor(0);
        doc.text(`Total (${priceMode}): ${formatCurrency(currentTotal)}`, 196, finalY, { align: 'right' });

        doc.setFontSize(10);
        doc.setTextColor(100);
        doc.text(`Range: ${formatCurrency(totals.low)} - ${formatCurrency(totals.high)}`, 196, finalY + 6, { align: 'right' });

        // Footer / Disclaimer
        doc.setFontSize(8);
        doc.setTextColor(150);
        doc.text('Estimates are based on Baguio City local market averages. Actual store prices may vary.', 14, 280);
        doc.text('Generated by Estima Baguio | by Goose', 196, 280, { align: 'right' });
